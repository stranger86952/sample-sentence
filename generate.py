...
"""
    ...
    for i, example in enumerate(examples):
        ...
        english_audio_tag = f'<audio controls preload="none">\n  <source src="{AUDIO_DIR}/{output_prefix}.mp3" type="audio/mpeg">\n</audio>' if mp3_audio_path else ''
...
if __name__ == "__main__":
    ...
    yaml_path = os.path.join(script_dir, 'beta.yaml')
    html_path = os.path.join(script_dir, 'beta.html')
